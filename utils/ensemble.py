...
class EnsembleBuffer:
    ...
    def get_recent_actions(self, num_recent_actions):
        """
        Get the most recent actions from the buffer.
        Don't change the buffer.
        """
        recent_actions = list(self.actions)[-num_recent_actions:]
    
        # Remove empty actions
        recent_actions = [action for action in recent_actions if action]
