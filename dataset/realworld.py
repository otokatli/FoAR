...
class RealWorldDataset(Dataset):
    ...
    def _augmentation(self, clouds, tcps, force_torques):
        ...
        for force_torque in force_torques:
            force_torque[:3] = aug_mat[:3, :3] @ force_torque[:3]
            force_torque[3:] = aug_mat[:3, :3] @ force_torque[3:]
        return clouds, tcps, force_torques
    ...
    def mask_point_cloud(self, points, colors, projector=None, cam_id="750612070851"):
    ...
    def __getitem__(self, index):
        ...
        for i, frame_id in enumerate(obs_frame_ids):
            ...
            points, colors = self.mask_point_cloud(points, colors, projector, cam_id)
